...
_wrap_new_CamKeypointShort(int argc, VALUE *argv, VALUE self) {
  ...
  result = (CamKeypointShort *)new CamKeypointShort();DATA_PTR(self) = result;
  SWIG_RubyAddTracking(result, self);
...
SWIGEXPORT void Init_camellia(void) {
  ...
  rb_define_const(mCamellia, "CAM_VERSION", SWIG_FromCharPtr("2.8.0 alpha 2 : Beaubourg ($Rev: 341 $)"));
